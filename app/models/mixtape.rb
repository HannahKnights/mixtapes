class Mixtape < ActiveRecord::Base
  ...
  def match_rate(match_mixtape)
    me = self.tracks
    you = match_mixtape
    me_song, me_artist, me_genre = mix_values(me, 'echonest_song_id') , mix_values(me, 'artist'), mix_values(me, 'genre')
    you_song, you_artist, you_genre = mix_values(you, 'echonest_song_id') , mix_values(you, 'artist'), mix_values(you, 'genre')
